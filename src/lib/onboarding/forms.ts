...
export const OnboardingInterests: {
    ...
    {
        id: "32ed4e77-730f-412a-8b7f-5f068f0f9f68",
        username: "Kiki",
        content:
            "美國一直以來自詡是擁抱多元的國家，尊重不同的信仰與文化。\n然而，如今將一方面美國想要把自己當作「世界警察」、「人類的救星」，但一旦威脅到那些資本家的利益，所有人又想高高掛起。美國的態度不只是單一個國家的立場，美國身為世界強國，歐盟的政策也勢必會受其影響，這些外部成本更可能讓各國的極右翼種族主義崛起，各國都越趨排外，相信這是大家都不樂見的。\n[喬治·華盛頓曾言：“I had always hoped that this land might become a safe and agreeable Asylum to the virtuous and persecuted part of mankind, to whatever nation they might belong.”](0)（我一直希望這片土地能成為所有正直而受迫害者的安全而宜人的庇護所，無論他們來自哪個國家。）\n我相信，美國之所以強大必定離不了美國價值的存在。這樣的難民政策會讓美國錯過下一個愛因斯坦，並在未來失去其霸權的地位。\n（尤其中國虎視眈眈：））",
    },
    {
    ...
    {
        id: "6f3a6f6c-3334-43c1-8a37-3d99e7add4eb",
        username: "Yuki",
        content:
            "根據卓揆的說法:[ 114年度已開始逾半個月，總預算遲遲未能審查完成，中央政府的運作出現諸多不確定性。](0)這事似乎拖很久了，造成行政效率低下。立法院也有報復與政黨意識的成分存在造成評斷有失客觀。",
    },
    {
        id: "4be8059a-192a-4c9e-89ef-bd868be0e2e1",
        username: "YC",
        content:
            "根據 [IZA 勞動經濟研究所的研究報告，美國在大幅減少接收難民後對經濟和財政是有很大的負面影響的](0)\n\n像是經濟損失平均約為三萬美元/難民，而財務損失近六千美元/難民\n\n雖然接收難民對於初期的成本開銷是大的，但長期創造的經濟價值會高於初期成本",
    },
    {
    ...
    },
    {
        ...
        username: "Albert",
        content:
            "近年來我國和解放軍的軍力差距越來越大，我國自從軍力被中國超越之後就一直奉行不對稱作戰的策略，而不對稱作戰中重要的一環就是潛艦[1]。\n解放軍已有12艘核動力潛艇和54艘常規動力潛艦。我國雖然不需要核動力潛艦，但我國擁有的常規動力潛艦都是二戰時期留下來的老古董，在戰時幾乎不構成戰力。2004至2006年期間我國的潛艦預算被國民黨擋了69次，原本應該在2019年成軍的8艘潛艦也隨之破滅[2]。\n\n軍武國造的好處就是能避免被外國掐著脖子，讓自己的命運被掌握在自己手裡，而現在好不容易有國造潛艦下水測試，卻被自己人一擋再擋，或許支持刪除預算的人會說現在的國造潛艦自製率不夠高所以沒必要繼續編列預算。\n但如果沒有開始何來的進步？從最初的幾艘潛艦累積經驗並培養相關產業人才。持續的資金挹注能讓這整條產業鏈持續發展並留住相關產業的人才，實現真正的自己自足，而不是斷斷續續的預算讓國造軍武在發展的路上綁手綁腳。\n\n[1]https://navy.mnd.gov.tw/Files/Paper/5-%E5%BB%BA%E6%A7%8B%E6%B0%B4%E4%B8%8B%E9%98%B2%E8%A1%9B%E8%87%AA%E4%B8%BB%E7%A7%91%E6%8A%80.pdf\n\n[2]https://watchout.tw/reports/8i7pZ85FZdGYTBGqtuqk",
    },
    {
