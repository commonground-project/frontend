                ...
                <div className="mt-2 flex justify-end gap-4">
                    {goBackButton ? (
                        <Button
                            ...
                            color="#a1a1a1"
                            onClick={() => {
                                if (goBackButtonCallback)
                                    goBackButtonCallback();
                            }}
                            className="flex items-center rounded-[4px] px-4 py-[6px] text-neutral-600 disabled:opacity-70"
                        >
                    ...
                    <Button
                        ...
                        className="flex items-center rounded-[4px] px-4 py-[6px] text-white"
